...
export interface ApiChallengeChallenge extends Schema.CollectionType {
  ...
  attributes: {
    ...
    code_projects: Attribute.Relation<
...
export interface ApiCodeProjectCodeProject extends Schema.CollectionType {
  ...
  attributes: {
    ...
    HtmlCode: Attribute.Blocks;
    JsCode: Attribute.Blocks;
    CssCode: Attribute.Blocks;
...
export interface ApiVersionVersion extends Schema.CollectionType {
  ...
  attributes: {
    ...
    JsCode: Attribute.Blocks;
    CssCode: Attribute.Blocks;
    code_project: Attribute.Relation<
      'api::version.version',
      'manyToOne',
      'api::code-project.code-project'
    >;
